...
import imgfourremovebg from "../imgs/imgfourremovebg.png";
...
const WhatWeDo = () => {
  ...
  return (
    <Box
      style={{
        background: 'radial-gradient(circle at 50% 50%, rgba(0, 9, 109, 1) 0%, rgba(19, 7, 228, 1) 50%, rgba(14, 0, 65, 1) 100%)',
        minHeight: '30vh',
        paddingTop: '50px',
        width: "100%",
        margin: "0 auto",
      ...
      <Container maxWidth="lg">
        <Grid container spacing={4} alignItems="center">
          ...
          <Grid item xs={12} sm={6} ref={imageRef}>
            <ZoomOutImage src={imgfourremovebg} />
          </Grid>
        </Grid>
      </Container>
    </Box>
